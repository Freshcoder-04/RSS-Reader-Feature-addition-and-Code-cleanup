...
public class AdblockUtil {
    ...
    private List<Subscription> parseSubscriptions() {
        if (subscriptions != null) {
            return subscriptions; // Return cached subscriptions
        }
    
        List<Subscription> parsedSubscriptions = new ArrayList<>();
    
        SAXParserFactory factory = SAXParserFactory.newInstance();
        try {
            SAXParser parser = factory.newSAXParser();
            parser.parse(AdblockUtil.class.getResourceAsStream("/adblock/subscriptions.xml"), new SubscriptionParser(parsedSubscriptions));
        } catch (Exception e) {
            log.error("Error parsing subscriptions", e);
        }
    
        subscriptions = parsedSubscriptions; // Cache parsed subscriptions
    ...
    public List<Subscription> getSubscriptions() {
        ...
        return parseSubscriptions(); // Just call the parsing method
    }
